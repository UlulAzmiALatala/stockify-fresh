        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="{{ route('admin.dashboard') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group {{ Request::is('admin/dashboard') ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
                    <svg class="w-6 h-6 text-gray-500" fill="currentColor" viewBox="0 0 20 20"><path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z"></path><path d="M12 2.252A8.014 8.014 0 0117.748 8H12V2.252z"></path></svg>
            ...
            <li>
                <button type="button" class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700 {{ Request::is('admin/transaksi/*') ? 'bg-gray-100 dark:bg-gray-700' : '' }}" aria-controls="dropdown-transactions" data-collapse-toggle="dropdown-transactions">
                    <svg class="w-6 h-6 text-gray-500" fill="currentColor" viewBox="0 0 20 20"><path d="M3 4a1 1 0 011-1h12a1 1 0 011 1v2a1 1 0 01-1 1H4a1 1 0 01-1-1V4zM3 10a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H4a1 1 0 01-1-1v-6zM14 9a1 1 0 00-1 1v6a1 1 0 001 1h2a1 1 0 001-1v-6a1 1 0 00-1-1h-2z"></path></svg>
            ...
            <li>
                <a href="{{ route('admin.products.index') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group {{ Request::is('admin/produk') ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
                    <svg class="w-6 h-6 text-gray-500" fill="currentColor" viewBox="0 0 20 20"><path d="M5 3a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2V5a2 2 0 00-2-2H5zm0 2h10v10H5V5z"></path></svg>
            ...
            <li>
             ...
             <li>
                <a href="{{ route('admin.users.index') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group {{ Request::is('admin/pengguna') ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
                    <svg class="w-6 h-6 text-gray-500" fill="currentColor" viewBox="0 0 20 20"><path d="M7 8a3 3 0 116 0 3 3 0 01-6 0zM5 8a5 5 0 1110 0A5 5 0 015 8z"></path><path d="M16.5 15.5a.75.75 0 00-1.5 0v.5a2.5 2.5 0 01-2.5 2.5h-5A2.5 2.5 0 015 16v-.5a.75.75 0 00-1.5 0v.5A4 4 0 007.5 20h5a4 4 0 004-4v-.5z"></path></svg>
                    <span class="flex-1 ml-3 whitespace-nowrap">Pengguna</span>
                </a>
            </li>
            <li>
                <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                   <svg class="w-6 h-6 text-gray-500" fill="currentColor" viewBox="0 0 20 20"><path d="M15 3.75A2.25 2.25 0 0012.75 6H7.25A2.25 2.25 0 005 3.75V2.25a.75.75 0 00-1.5 0V3.75A3.75 3.75 0 007.25 7.5h5.5A3.75 3.75 0 0016.5 3.75V2.25a.75.75 0 00-1.5 0V3.75z"></path><path d="M3.5 8.75A.75.75 0 002.75 8h-1.5a.75.75 0 000 1.5h1.5a.75.75 0 00.75-.75zM17.25 8a.75.75 0 00-.75.75h1.5a.75.75 0 000-1.5h-1.5a.75.75 0 00-.75.75zM12 17.25a.75.75 0 01-.75-.75V11.25a.75.75 0 011.5 0v5.25a.75.75 0 01-.75.75zM8.25 17.25a.75.75 0 01-.75-.75V14.25a.75.75 0 011.5 0v2.25a.75.75 0 01-.75.75zM4.5 17.25a.75.75 0 01-.75-.75v-2a.75.75 0 011.5 0v2a.75.75 0 01-.75.75zM15.75 17.25a.75.75 0 01-.75-.75v-5a.75.75 0 011.5 0v5a.75.75 0 01-.75.75z"></path></svg>
