<aside id="logo-sidebar"
    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
        {{-- Memberi jarak dari atas navbar --}}
        <ul class="space-y-2 font-medium mt-5">
            ...
            {{-- 1. MENU DASHBOARD (Untuk Semua Role) --}}
            <li>
            ...
            {{-- 2. MENU MANAJEMEN PRODUK (Admin & Manager) --}}
            ...
            {{-- 3. MENU MANAJEMEN STOK (Admin, Manager, Staff) --}}
            @php
            ...
            {{-- 5. PENGATURAN & MANAJEMEN PENGGUNA (Hanya Admin) --}}
            @role('admin')
                ...
                <li>
                    <a href="{{ route('users.index') }}" 
                       class="flex items-center p-2 rounded-lg group transition duration-200 ease-in-out hover:translate-x-2 {{ request()->routeIs('users.*') ? $activeClass : $inactiveClass }}">
                        <i class="w-5 h-5 text-center {{ request()->routeIs('users.*') ? 'text-primary-600 dark:text-primary-400' : 'text-gray-500 dark:text-gray-400 group-hover:text-primary-600 dark:group-hover:text-primary-400' }} fa-solid fa-users-cog transition duration-200 ease-in-out"></i>
