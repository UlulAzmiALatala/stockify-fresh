{{-- ======================== MODAL TAMBAH PRODUK (DIPERBAIKI & DIPERCANTIK) ======================== --}}
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <div class="grid gap-4 sm:grid-cols-2">
                            <div>
                                ...
                                <input type="text" name="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600" placeholder="Contoh: Laptop ProBook 14" value="{{ old('name') }}" required>
                                @error('name')<p class="mt-1 text-xs text-red-500">{{ $message }}</p>@enderror
                            </div>
                            <div>
                                <label for="sku" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">SKU</label>
                                <input type="text" name="sku" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600" placeholder="Contoh: LP-PB-14-001" value="{{ old('sku') }}" required>
                            ...
                            <div>
                                ...
                                <select name="category_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600" required>
                            ...
                            <div>
                                ...
                                <select name="supplier_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600" required>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <div class="grid gap-4 sm:grid-cols-2">
                             <div>
                                ...
                                <input type="number" name="purchase_price" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600" placeholder="10000000" value="{{ old('purchase_price') }}" required>
                            ...
                            <div>
                                ...
                                <input type="number" name="selling_price" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600" placeholder="12500000" value="{{ old('selling_price') }}" required>
                            ...
                            <div>
                                ...
                                <input type="number" name="minimum_stock" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600" placeholder="10" value="{{ old('minimum_stock') }}" required>
                        ...
                        <h4 class="text-md font-semibold text-gray-900 dark:text-white border-b dark:border-gray-700 pb-2 mb-4">Detail Tambahan</h4>
                         <div class="space-y-4">
                                ...
                                <div class="space-y-3">
                                    @foreach ($attributes as $attribute)
                                        <div class="grid grid-cols-3 gap-4 items-center">
                                            <label for="attribute-{{ $attribute->id }}" class="col-span-1 text-sm font-medium text-gray-900 dark:text-gray-300">{{ $attribute->name }}</label>
                                            <div class="col-span-2">
                                                 <input type="text" name="attributes[{{ $attribute->id }}]" id="attribute-{{ $attribute->id }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600" placeholder="Masukkan nilai...">
                                            </div>
                                        </div>
                                    @endforeach
                                </div>
                            ...
                            <div>
                                ...
                                <textarea name="description" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 dark:bg-gray-700 dark:border-gray-600" placeholder="Tulis deskripsi produk di sini...">{{ old('description') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>

                <div class="flex justify-end pt-4 border-t dark:border-gray-600 mt-6">
