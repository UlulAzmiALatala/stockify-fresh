        ...
        <form action="{{ route('settings.update') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="text" name="app_name" id="app_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700" value="{{ old('app_name', $settings['app_name'] ?? 'Stockify') }}" required>
