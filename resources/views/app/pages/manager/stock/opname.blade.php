        ...
        <form action="{{ route('manager.stock.opname.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                <div>
                    ...
                    {{-- MODIFIKASI PADA SELECT --}}
                    <select name="product_id" id="product_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" required>
                ...
                <div>
                    ...
                    {{-- MODIFIKASI PADA INPUT --}}
                    <input type="number" name="physical_stock" id="physical_stock" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Masukkan jumlah hitungan fisik" value="{{ old('physical_stock') }}" required>
                ...
                <div class="lg:col-span-2">
                    ...
                    {{-- MODIFIKASI PADA TEXTAREA --}}
                    <textarea name="notes" id="notes" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-600 focus:border-primary-600 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Contoh: Hasil perhitungan stok bulanan" required>{{ old('notes') }}</textarea>
